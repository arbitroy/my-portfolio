    ...
    <Timeline>
      <TimelineEvent active>
        <TimelineEvent.Title>
          ...
          | May. 2024 - {calculateDuration('2024-03-01', true)}
        </TimelineEvent.Title>

        <TimelineEvent.Description>
          Acquired proficiency in the codebase and honed coding skills.
          Conducted analysis of user requirements and software needs to inform
          system design. Developed software applications and programs for both
          backend and frontend purposes. Evaluated programs and applications to
          enhance their features and functionalities.
        </TimelineEvent.Description>
      </TimelineEvent>
