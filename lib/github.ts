...
export class GitHubService {
    ...
    async getRepositoryLanguages(repo: GitHubRepo): Promise<Record<string, number>> {
    ...
    async getPortfolioProjects(): Promise<ProjectData[]> {
        ...
        for (const repo of repos) {
            ...
            const mainLanguage = Object.keys(languages)[0] || repo.language || 'Unknown';
    ...
    private formatCategory(languages: Record<string, number>, topics: string[]): string {
